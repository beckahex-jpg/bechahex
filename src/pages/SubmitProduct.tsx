...
import { X, Upload, FileText, DollarSign, Image as ImageIcon, Check } from 'lucide-react';
...
export default function SubmitProduct() {
  ...
  const handleSubmit = async () => {
    try {
      ...
      alert('Product submitted successfully! It will be reviewed by our team.');
      navigate('/dashboard');
    } catch (error) {
            ...
            <div>
              ...
              <div className="space-y-3">
                ...
                >
                  ...
                  <div className="text-sm text-gray-600">Give away for free to support the cause</div>
                </button>
                <button
                  type="button"
                ...
                >
                  <div className="font-semibold text-gray-900">Symbolic Sale</div>
                  <div className="text-sm text-gray-600">Sell at a minimal price</div>
                </button>
                <button
                  type="button"
                ...
                >
                  <div className="font-semibold text-gray-900">Public Sale</div>
                  <div className="text-sm text-gray-600">Sell to the general public</div>
                </button>
              </div>
            </div>
