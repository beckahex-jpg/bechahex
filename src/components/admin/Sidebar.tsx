...
export default function Sidebar({ activeSection, onSectionChange, pendingSubmissions, isOpen, onClose }: SidebarProps) {
  ...
  return (
    <>
      ...
      <aside className={`w-64 bg-white border-r border-gray-200 h-screen fixed left-0 top-0 z-50 transform transition-transform duration-300 ease-in-out ${
