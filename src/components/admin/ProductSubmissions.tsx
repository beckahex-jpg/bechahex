...
export default function ProductSubmissions({ onSubmissionChange, searchQuery = '' }: ProductSubmissionsProps) {
  ...
  const handleUpdateSubmission = async () => {
    ...
    try {
      ...
      if (selectedSubmission.status === 'approved' && selectedSubmission.product_id) {
  ...
  return (
    <div>
      <div className="mb-6">
        <h1 className="text-2xl lg:text-3xl font-bold text-gray-900 mb-2">Product Submissions</h1>
                  ...
                  <div className="bg-gray-50 rounded-xl p-5 border border-gray-200">
                    ...
                    <div className="grid grid-cols-1 gap-4">
                      ...
                      <div className="bg-blue-50 border-2 border-blue-200 rounded-xl p-4 mb-4">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                          <div>
                            <label className="text-xs font-semibold text-gray-600 uppercase tracking-wide">Submission Type</label>
                            <p className="font-bold text-gray-900 mt-1">
                              {selectedSubmission.submission_type === 'donation' && '🎁 Full Donation'}
                              {selectedSubmission.submission_type === 'symbolic_sale' && '💵 Symbolic Sale'}
                              {selectedSubmission.submission_type === 'public_sale' && '💰 Regular Sale'}
                            </p>
                          </div>
                          {selectedSubmission.original_price && (
                            <div>
                        ...
                        <div className="grid grid-cols-2 gap-4 mt-3">
                          <div>
                            <label className="text-xs font-semibold text-gray-600 uppercase tracking-wide">Public Sale Price</label>
                          ...
                          {selectedSubmission.seller_symbolic_price !== null && selectedSubmission.seller_symbolic_price > 0 && (
                            <div className="bg-yellow-50 border-2 border-yellow-300 rounded-lg p-2">
                              <label className="text-xs font-semibold text-yellow-800 uppercase tracking-wide flex items-center gap-1">
                                🔒 Seller Symbolic Price (Private)
                              </label>
                              <p className="font-bold text-yellow-800 mt-1 text-xl flex items-center gap-1">
                                <DollarSign className="w-5 h-5" />
                                ${selectedSubmission.seller_symbolic_price}
                              </p>
                          ...
                          {selectedSubmission.ai_suggested_price && (
                            <div>
                              <label className="text-xs font-semibold text-purple-500 uppercase tracking-wide">🤖 AI Suggested</label>
                        ...
                        {selectedSubmission.submission_type === 'symbolic_sale' && selectedSubmission.seller_symbolic_price && (
                          <div className="mt-3 p-3 bg-emerald-50 border border-emerald-200 rounded-lg">
                            <p className="text-sm font-semibold text-emerald-900">💰 Financial Breakdown:</p>
                            <div className="mt-2 space-y-1 text-sm">
                              <div className="flex justify-between">
                                <span className="text-emerald-700">Product will sell for:</span>
                                <span className="font-bold text-emerald-900">${selectedSubmission.price}</span>
                              </div>
                              <div className="flex justify-between">
                                <span className="text-emerald-700">Transfer to seller:</span>
                                <span className="font-bold text-emerald-900">${selectedSubmission.seller_symbolic_price}</span>
                              </div>
                              <div className="flex justify-between border-t border-emerald-300 pt-1">
                                <span className="text-emerald-800 font-semibold">Keep for charity:</span>
                                <span className="font-bold text-emerald-900">${(selectedSubmission.price - (selectedSubmission.seller_symbolic_price || 0)).toFixed(2)}</span>
                              </div>
                            </div>
                          </div>
                        )}
                        {selectedSubmission.submission_type === 'donation' && (
                          <div className="mt-3 p-3 bg-green-50 border border-green-200 rounded-lg">
                            <p className="text-sm font-semibold text-green-900">🎁 Full Donation:</p>
                            <p className="text-xs text-green-700 mt-1">
                              100% of sale proceeds (${selectedSubmission.price}) will go to charity
                            </p>
                          </div>
                        )}
                      </div>
