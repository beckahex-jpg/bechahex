...
DROP POLICY IF EXISTS "Admin can update all products" ON products;
DROP POLICY IF EXISTS "Admin can delete all products" ON products;
...
DROP POLICY IF EXISTS "Users can create their own submissions" ON product_submissions;
...
DROP POLICY IF EXISTS "Admin can view all submissions" ON product_submissions;
DROP POLICY IF EXISTS "Admin can update all submissions" ON product_submissions;
DROP POLICY IF EXISTS "Admin can delete all submissions" ON product_submissions;
...
-- 10. INSERT SAMPLE CATEGORIES (OPTIONAL)
-- ========================================
